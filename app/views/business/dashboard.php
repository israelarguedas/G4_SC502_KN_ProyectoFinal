...
// Inicializar la vista en la pestaña de comercios al cargar
document.addEventListener('DOMContentLoaded', () => {
    // Asegurarse de que el primer tab (comercios) esté activo y visible por defecto
    document.querySelector('.admin-tab[data-tab="comercios"]').click();
});
</script>
