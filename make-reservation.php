...
<head>
    ...
    <title>Tico Trips - Hacer Reservación</title>
            ...
            <form id="reservation-form" class="p-6 space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" required id="id-number"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500"
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" required id="reservation-date"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select required id="people-count"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea rows="3" placeholder="Alergias, necesidades especiales, preferencias..."
                ...
                <div class="bg-gray-50 p-6 -mx-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-medium">₡9,100</span>
                        </div>
                        <div class="border-t pt-2 mt-2">
                            <div class="flex justify-between">
                                <span class="text-lg font-semibold">Total</span>
                                <span class="text-lg font-bold text-teal-600">₡79,100</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePrices() {
                ...
                document.querySelector('[data-price="tax"]').textContent = `₡${tax.toLocaleString()}`;
                document.querySelector('[data-price="total"]').textContent = `₡${total.toLocaleString()}`;
            }
            ...
            form.addEventListener('submit', function(e) {
                ...
                alert('¡Reserva enviada con éxito! Recibirás un correo de confirmación.');
                
                // Redireccionar a la página de confirmación o al inicio
