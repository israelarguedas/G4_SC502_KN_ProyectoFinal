  ...
  <body class="pb-16 sm:pb-0">
    ...
    >
      <div class="flex items-center justify-between h-14 sm:hidden">
        <a href="reservations.php" class="flex-1 text-center text-sm text-gray-700">Reservar</a>
        <a href="promotions.php" class="flex-1 text-center text-teal-600 font-semibold"
          >Cupones</a
        >
        <a href="userProfile.php" class="flex-1 flex items-center justify-center">
      ...
      <div class="hidden sm:flex items-center justify-center h-16">
        <div class="flex items-center justify-between w-full">
          <div class="flex-1 flex space-x-6 text-gray-700 text-sm font-semibold">
              <a href="reservations.php" class="hover:text-teal-600">Reservaciones</a>
              <a href="promotions.php" class="hover:text-teal-600">Cupones B2B</a>
          </div>

          <h3 class="logo-text [word-spacing:0.35rem] tracking-wide text-2xl font-bold text-teal-600">
            TicoTrips
          </h3>

          <ul class="flex-1 flex justify-end items-center space-x-4">
            <li>
              <a href="admin-panel.php" class="text-red-500 hover:text-red-700 text-sm font-semibold">
            ...
            <li class="relative">
                <button id="profile-menu-button"
                    ...
                    class="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-500">
                    <i class="fa-solid fa-circle-user fa-xl"></i>
                </button>
               
                <div id="profile-menu-dropdown"
                     class="absolute right-0 mt-2 w-52 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 hidden z-10">
                    <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="profile-menu-button">
                        <a href="userProfile.php"
                           class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                           role="menuitem">
                            <i class="fas fa-user-circle mr-2 w-4"></i> Mi Perfil
                        </a>
                        <a href="login-register.php?tab=business-register"
                           class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                           role="menuitem">
                            <i class="fas fa-store mr-2 w-4"></i> Registrar Nuevo Negocio
                        </a>
      ...
      >
        ...
        <div>
          <div class="flex items-center gap-4 search-home-page">
            <input
              class="shadow-md border border-gray-300 rounded-lg p-3 w-4/12 mx-auto"
              type="text"
              name=""
              id=""
